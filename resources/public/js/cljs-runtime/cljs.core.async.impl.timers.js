...
while(true){
if((i <= self__.level)){
var links_13998 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13998[i]));
} else {
x__$2.forward.push((((i < links_13998.length))?(links_13998[i]):null));
}

if((i < links_13998.length)){
(links_13998[i] = x__$2);
} else {
links_13998.push(x__$2);
}
...
var i_14005 = (0);
while(true){
if((i_14005 <= self__.level)){
var links_14006 = (update[i_14005]).forward;
if((x__$1 === (((i_14005 < links_14006.length))?(links_14006[i_14005]):null))){
(links_14006[i_14005] = (x__$1.forward[i_14005]));

var G__14008 = (i_14005 + (1));
i_14005 = G__14008;
continue;
} else {
var G__14009 = (i_14005 + (1));
i_14005 = G__14009;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__14035 = nx;
var G__14036 = (level__$1 - (1));
x = G__14035;
level__$1 = G__14036;
continue;
} else {
var G__14037 = x;
var G__14038 = (level__$1 - (1));
x = G__14037;
level__$1 = G__14038;
continue;
}
