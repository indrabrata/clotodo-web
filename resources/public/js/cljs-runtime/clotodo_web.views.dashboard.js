...
clotodo_web.api.get_rooms((function (p1__11949_SHARP_){
return cljs.core.reset_BANG_(clotodo_web.state.rooms,p1__11949_SHARP_);
}));
...
})], null),"Join Room"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.rooms-grid","div.rooms-grid",966115774),((cljs.core.empty_QMARK_(cljs.core.deref(clotodo_web.state.rooms)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.empty-state","div.empty-state",1970626869),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"No rooms yet. Create one to get started!"], null)], null):(function (){var iter__5503__auto__ = (function clotodo_web$views$dashboard$dashboard_page_$_iter__11958(s__11959){
return (new cljs.core.LazySeq(null,(function (){
var s__11959__$1 = s__11959;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__11959__$1);
if(temp__5823__auto__){
var s__11959__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__11959__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__11959__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__11961 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__11960 = (0);
while(true){
if((i__11960 < size__5502__auto__)){
var room = cljs.core._nth(c__5501__auto__,i__11960);
cljs.core.chunk_append(b__11961,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.room-card","div.room-card",-376969732),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__11960,room,c__5501__auto__,size__5502__auto__,b__11961,s__11959__$2,temp__5823__auto__,show_create,show_join,room_name,is_public,join_code){
return (function (){
...
});})(i__11960,room,c__5501__auto__,size__5502__auto__,b__11961,s__11959__$2,temp__5823__auto__,show_create,show_join,room_name,is_public,join_code))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__11961),clotodo_web$views$dashboard$dashboard_page_$_iter__11958(cljs.core.chunk_rest(s__11959__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__11961),null);
}
} else {
var room = cljs.core.first(s__11959__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.room-card","div.room-card",-376969732),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (room,s__11959__$2,temp__5823__auto__,show_create,show_join,room_name,is_public,join_code){
return (function (){
cljs.core.reset_BANG_(clotodo_web.state.current_room,room);

return cljs.core.reset_BANG_(clotodo_web.state.current_page,new cljs.core.Keyword(null,"room","room",536484922));
});})(room,s__11959__$2,temp__5823__auto__,show_create,show_join,room_name,is_public,join_code))
], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3.room-name","h3.room-name",1513291031),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(room)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.room-info","div.room-info",2101442209),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.room-badge","span.room-badge",-977620630),(cljs.core.truth_(new cljs.core.Keyword(null,"is_public","is_public",-1453727950).cljs$core$IFn$_invoke$arity$1(room))?"Public":"Private")], null),(cljs.core.truth_(new cljs.core.Keyword(null,"is_public","is_public",-1453727950).cljs$core$IFn$_invoke$arity$1(room))?null:new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.room-code","span.room-code",-386246486),"Code: ",new cljs.core.Keyword(null,"access_code","access_code",1516946670).cljs$core$IFn$_invoke$arity$1(room)], null))], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(room)], null)),clotodo_web$views$dashboard$dashboard_page_$_iter__11958(cljs.core.rest(s__11959__$2)));
}
} else {
return null;
}
...
return clotodo_web.api.get_rooms((function (p1__11953_SHARP_){
return cljs.core.reset_BANG_(clotodo_web.state.rooms,p1__11953_SHARP_);
}));
}));
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.modal-input","input.modal-input",-1654541497),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Room Name",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(room_name),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__11954_SHARP_){
return cljs.core.reset_BANG_(room_name,p1__11954_SHARP_.target.value);
}),new cljs.core.Keyword(null,"required","required",1807647006),true], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.checkbox-label","label.checkbox-label",764222037),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"checked","checked",-50955819),cljs.core.deref(is_public),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__11955_SHARP_){
return cljs.core.reset_BANG_(is_public,p1__11955_SHARP_.target.checked);
...
return clotodo_web.api.get_rooms((function (p1__11956_SHARP_){
return cljs.core.reset_BANG_(clotodo_web.state.rooms,p1__11956_SHARP_);
}));
}));
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.modal-input","input.modal-input",-1654541497),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Enter Room Code",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(join_code),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__11957_SHARP_){
return cljs.core.reset_BANG_(join_code,p1__11957_SHARP_.target.value);
