...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13867 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13867(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13871 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13871(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_13872 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_13872(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13882 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13882(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13891 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13891(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13904 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13904(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13830,callback){
var map__13831 = p__13830;
var map__13831__$1 = cljs.core.__destructure_map(map__13831);
var input = map__13831__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13831__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13831__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
