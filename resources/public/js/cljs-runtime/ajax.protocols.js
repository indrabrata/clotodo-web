...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_21865 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_21865(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_21870 = (function (this$){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_21870(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_21874 = (function (this$){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_21874(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_21879 = (function (this$){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_21879(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_21881 = (function (this$){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_21881(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_21884 = (function (this$){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_21884(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_21894 = (function (this$,header){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_21894(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_21901 = (function (this$){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_21901(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_21906 = (function (this$,request){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_21906(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_21907 = (function (this$,response){
var x__5373__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_21907(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5325__auto__,k21735,else__5326__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21735,else__5326__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5346__auto__,p__21747){
var vec__21748 = p__21747;
var k__5347__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21748,(0),null);
var v__5348__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21748,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21734){
var self__ = this;
var G__21734__$1 = this;
return (new cljs.core.RecordIter((0),G__21734__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this21736,other21737){
var self__ = this;
var this21736__$1 = this;
return (((!((other21737 == null)))) && ((((this21736__$1.constructor === other21737.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21736__$1.status,other21737.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21736__$1.body,other21737.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21736__$1.status_text,other21737.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21736__$1.headers,other21737.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21736__$1.was_aborted,other21737.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21736__$1.__extmap,other21737.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5330__auto__,k21735){
var self__ = this;
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5331__auto__,k__5332__auto__,G__21734){
var self__ = this;
var this__5331__auto____$1 = this;
var pred__21825 = cljs.core.keyword_identical_QMARK_;
var expr__21826 = k__5332__auto__;
if(cljs.core.truth_((pred__21825.cljs$core$IFn$_invoke$arity$2 ? pred__21825.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__21826) : pred__21825.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__21826)))){
return (new ajax.protocols.Response(G__21734,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__21825.cljs$core$IFn$_invoke$arity$2 ? pred__21825.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__21826) : pred__21825.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__21826)))){
return (new ajax.protocols.Response(self__.status,G__21734,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__21825.cljs$core$IFn$_invoke$arity$2 ? pred__21825.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__21826) : pred__21825.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__21826)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__21734,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__21825.cljs$core$IFn$_invoke$arity$2 ? pred__21825.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__21826) : pred__21825.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__21826)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__21734,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__21825.cljs$core$IFn$_invoke$arity$2 ? pred__21825.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__21826) : pred__21825.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__21826)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__21734,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5332__auto__,G__21734),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5322__auto__,G__21734){
var self__ = this;
var this__5322__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__21734,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__21738){
var extmap__5365__auto__ = (function (){var G__21855 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21738,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__21738)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__21855);
} else {
return G__21855;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__21738),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__21738),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__21738),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__21738),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__21738),null,cljs.core.not_empty(extmap__5365__auto__),null));
});
