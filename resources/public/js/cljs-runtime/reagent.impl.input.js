...
var G__21510 = shadow_root.activeElement;
active_element = G__21510;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__21452){
var map__21453 = p__21452;
var map__21453__$1 = cljs.core.__destructure_map(map__21453);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21453__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__21463 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__21464 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__21464);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__21463);
}}));
} else {
...
(jsprops.onChange = (function (p1__21470_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__21470_SHARP_);
}));
