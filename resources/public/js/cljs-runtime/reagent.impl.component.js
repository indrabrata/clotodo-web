...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21245 = c;
var G__21245__$1 = (((G__21245 == null))?null:G__21245.prototype);
if((G__21245__$1 == null)){
return null;
} else {
return G__21245__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21251 = c;
var G__21251__$1 = (((G__21251 == null))?null:G__21251.prototype);
if((G__21251__$1 == null)){
return null;
} else {
return G__21251__$1.render;
}
})() == null)))));
});
...
while (G__21442__i < G__21442__a.length) {G__21442__a[G__21442__i] = arguments[G__21442__i + 0]; ++G__21442__i;}
  args = new cljs.core.IndexedSeq(G__21442__a,0,null);
} 
...
var or__5025__auto__ = (function (){var G__21261 = c;
var G__21261__$1 = (((G__21261 == null))?null:G__21261.constructor);
if((G__21261__$1 == null)){
return null;
} else {
return G__21261__$1.displayName;
}
})();
...
var G__21262 = c;
var G__21262__$1 = (((G__21262 == null))?null:G__21262.constructor);
if((G__21262__$1 == null)){
return null;
} else {
return G__21262__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21272 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21273 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21273);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21272);
}});
...
var c = this;
var G__21334_21461 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21334_21461 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21334_21461);
}
...
var renders_21466 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21467 = cljs.core.first(cljs.core.vals(renders_21466));
...
if((cljs.core.count(renders_21466) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_21466))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_21467)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_21467], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__21377 = o;
reagent.impl.component.goog$module$goog$object.set(G__21377,cljs.core.name(k),v);
...
return (function() { 
var G__21483__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__21489__i < G__21489__a.length) {G__21489__a[G__21489__i] = arguments[G__21489__i + 0]; ++G__21489__i;}
  args = new cljs.core.IndexedSeq(G__21489__a,0,null);
} 
return G__21483__delegate.call(this,args);};
G__21483.cljs$lang$maxFixedArity = 0;
G__21483.cljs$lang$applyTo = (function (arglist__21491){
var args = cljs.core.seq(arglist__21491);
return G__21483__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__21413 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21414 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21414);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21413);
}});
...
var vec__21415 = module$node_modules$react$index.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21415,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21415,(1),null);
...
if(cljs.core.truth_(reagent_state.cleanup_queued)){
(reagent_state.cleanup_cancelled = true);

(reagent_state.cleanup_queued = false);
} else {
}

return (function reagent$impl$component$functional_render_$_mount_$_unmount(){
(reagent_state.cleanup_cancelled = false);

(reagent_state.cleanup_queued = true);

return Promise.resolve(null).then((function (){
if(reagent_state.cleanup_cancelled === false){
(reagent_state.cleanup_queued = false);

var G__21425 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__21425 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__21425);
}
} else {
return null;
}
