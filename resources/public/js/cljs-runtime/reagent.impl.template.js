...
var G__21559 = o;
reagent.impl.template.goog$module$goog$object.set(G__21559,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__21565 = o;
reagent.impl.template.goog$module$goog$object.set(G__21565,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__21762__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__21762 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__21763__i < G__21763__a.length) {G__21763__a[G__21763__i] = arguments[G__21763__i + 0]; ++G__21763__i;}
  args = new cljs.core.IndexedSeq(G__21763__a,0,null);
} 
return G__21762__delegate.call(this,args);};
G__21762.cljs$lang$maxFixedArity = 0;
G__21762.cljs$lang$applyTo = (function (arglist__21764){
var args = cljs.core.seq(arglist__21764);
return G__21762__delegate(args);
});
...
var G__21579 = props;
var G__21579__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21579,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21579);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21579__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21590 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21590,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21590;
}
})(),id_class);
...
var temp__5823__auto___21766 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5823__auto___21766)){
var d_21767 = temp__5823__auto___21766;
if((d_21767 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_21767.s}));
} else {
...
var G__21597 = (cljs.core.count(argv) - first_child);
switch (G__21597) {
case (0):
...
var vec__21605 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21605,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21605,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21605,(2),null);
...
var temp__5827__auto___21776 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___21776 == null)){
} else {
var key_21777 = temp__5827__auto___21776;
(jsprops.key = key_21777);
}
...
var temp__5827__auto___21778 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___21778 == null)){
} else {
var key_21780 = temp__5827__auto___21778;
(jsprops.key = key_21780);
}
...
var temp__5827__auto___21782 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___21782 == null)){
} else {
var key_21784 = temp__5827__auto___21782;
(jsprops.key = key_21784);
}
...
var temp__5827__auto___21787 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___21787 == null)){
} else {
var key_21788 = temp__5827__auto___21787;
(jsprops.key = key_21788);
}
...
var temp__5827__auto___21791 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___21791 == null)){
} else {
var key_21793 = temp__5827__auto___21791;
(jsprops.key = key_21793);
}
...
var temp__5827__auto___21798 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___21798 == null)){
} else {
var key_21799 = temp__5827__auto___21798;
(jsprops.key = key_21799);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21653_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21653_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21658 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21658,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21658,(1),null);
...
break;
default:
var G__21811 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__21812 = compiler;
v = G__21811;
compiler = G__21812;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template21725 = (function (opts,id,fn_to_element,parse_fn,meta21726){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21725.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21727,meta21726__$1){
var self__ = this;
var _21727__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21725(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21726__$1));
}));

(reagent.impl.template.t_reagent$impl$template21725.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21727){
var self__ = this;
var _21727__$1 = this;
return self__.meta21726;
}));

(reagent.impl.template.t_reagent$impl$template21725.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21725.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21725.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template21725.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21725.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21725.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21726","meta21726",-878204932,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21725.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21725.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21725");

(reagent.impl.template.t_reagent$impl$template21725.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template21725");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21725.
 */
reagent.impl.template.__GT_t_reagent$impl$template21725 = (function reagent$impl$template$__GT_t_reagent$impl$template21725(opts,id,fn_to_element,parse_fn,meta21726){
return (new reagent.impl.template.t_reagent$impl$template21725(opts,id,fn_to_element,parse_fn,meta21726));
});
...
return (new reagent.impl.template.t_reagent$impl$template21725(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
