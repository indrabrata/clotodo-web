...
var G__22655 = request;
var G__22656 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__22655,G__22656) : ajax.formats.get_format.call(null,G__22655,G__22656));
} else {
...
return cljs.core.some((function (p1__22659_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__22659_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__22663){
var map__22664 = p__22663;
var map__22664__$1 = cljs.core.__destructure_map(map__22664);
var request = map__22664__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22664__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__22670 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__22670.cljs$core$IFn$_invoke$arity$1 ? fexpr__22670.cljs$core$IFn$_invoke$arity$1(response) : fexpr__22670.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__22675){
var map__22676 = p__22675;
var map__22676__$1 = cljs.core.__destructure_map(map__22676);
var request = map__22676__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22676__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__22671_SHARP_){
return ajax.formats.get_accept_entries(request,p1__22671_SHARP_);
